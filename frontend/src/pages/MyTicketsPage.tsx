...
export function MyTicketsPage() {
    ...
    const {data: blockchainTickets, isLoading: isLoadingTickets, error: ticketsError} = useMyTickets(deployedAddresses.sampleNFT, address);
    ...
    const tickets = React.useMemo(() => {
        ...
        if (!blockchainTickets || blockchainTickets.length === 0) {
            ...
            return mockTickets.filter((ticket) => ticket.owner.toLowerCase() === (smartAccountAddress || address)?.toLowerCase());
        }
        ...
        return blockchainTickets.map((ticket) => ({
            ...
            sellingPrice: ticket.isForSale ? (BigInt(ticket.sellingPrice) / BigInt(10 ** 18)).toString() : undefined,
    ...
    const handleSellTicket = async () => {
        ...
        if (parseFloat(price) > maxPrice) {
            toast.error(`Price cannot exceed ${maxPrice.toFixed(2)} FEST (110% of purchase price)`);
            return;
        }
        ...
        return (
            <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 flex items-center justify-center">
                <div className="text-center max-w-md mx-auto p-8">
                    ...
                    <p className="text-slate-600 mb-6 text-lg">Please connect your wallet to view and manage your festival tickets</p>
            ...
            <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50">
                <div className="container mx-auto px-4 py-8">
                    <div className="text-center py-20">
                        ...
                        <p className="text-xl font-medium text-slate-700 animate-pulse">Loading your tickets...</p>
                        <p className="text-sm text-slate-500 mt-2">🎫 Fetching from blockchain</p>
                    </div>
                </div>
            </div>
        );
            ...
            <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50">
                <div className="container mx-auto px-4 py-8">
                    <div className="text-center py-20">
                        ...
                        <p className="text-xl text-red-600 font-semibold mb-2">Error loading tickets</p>
            ...
            <aside className="sidebar">
                <div className="sidebar-header">
                    <div className="user-avatar">
                        <span className="avatar-text">{address ? address.slice(2, 4).toUpperCase() : "FM"}</span>
                    </div>
                        ...
                        <div className="user-address">
                            <span className="address-mono">
                                {smartAccountAddress || address
                                    ? `${(smartAccountAddress || address)?.slice(0, 6)}...${(smartAccountAddress || address)?.slice(-4)}`
                                    : "Not connected"}
                            </span>
                            <button onClick={copyAddress} className="copy-icon" title="Sao chép địa chỉ">
                ...
                <div className="sidebar-stats">
                    ...
                    <div className="stat-item">
                        <div className="stat-value">{tickets?.filter((t) => t.isForSale).length || 0}</div>
            ...
            <main className="main-content">
                <div className="content-header">
                    <div className="header-top">
                        ...
                        <p className="page-description">Quản lý vé sự kiện và NFT của bạn</p>
                    </div>
                    ...
                    <div className="filter-tabs">
                        ...
                        <button className={`filter-tab ${activeFilter === "for-sale" ? "active" : ""}`} onClick={() => setActiveFilter("for-sale")}>
                            Đang bán
                            <span className="tab-count">{tickets?.filter((t) => t.isForSale).length || 0}</span>
                        </button>
                        <button
                            className={`filter-tab ${activeFilter === "not-listed" ? "active" : ""}`}
                ...
                <div className="tickets-section">
                    {filteredTickets && filteredTickets.length > 0 ? (
                        ...
                        <div className="empty-state">
                            ...
                            {activeFilter === "all" && (
                                <button onClick={() => (window.location.href = "/")} className="btn-explore">
                                    🔍 Khám phá sự kiện
                ...
                {sellModalData.ticket && (
                    <SellTicketModal
                        ...
                        onPriceChange={(price) => setSellModalData({...sellModalData, price})}
                        ...
                        <>
                            ...
                            <div className="price-row">
                                ...
                                <div className="selling-price">
                                    ...
                                    <span className="price-value-highlight">{ticket.sellingPrice} FEST</span>
                                </div>
                            </div>
                            {priceIncrease && <div className="price-increase">+{priceIncrease}% so với giá gốc</div>}
                        </>
                    )}
                </div>
...
function SellTicketModal({ticket, price, onPriceChange, onClose, onConfirm, loading}: SellTicketModalProps) {
    const maxPrice = parseFloat(ticket.purchasePrice) * 1.1;
    const currentPrice = parseFloat(price) || 0;
    const isValidPrice = currentPrice > 0 && currentPrice <= maxPrice;
    const priceIncrease = currentPrice > 0 ? ((currentPrice / parseFloat(ticket.purchasePrice) - 1) * 100).toFixed(1) : "0";
                ...
                <div className="modal-body">
                    ...
                    <div className="ticket-info-card">
                        ...
                        <div className="original-price-display">
                            ...
                            <span className="original-price-value">{ticket.purchasePrice} FEST</span>
                        </div>
                    </div>
                    ...
                    <div className="warning-box">
                        ...
                        <div className="warning-content">
                            ...
                            <p className="warning-text">
                                Giá bán không được vượt quá <strong>110%</strong> giá mua ban đầu.
                                <br />
                                <span className="max-price-highlight">Giá tối đa: {maxPrice.toFixed(2)} FEST</span>
                            </p>
                        </div>
                    </div>
                    ...
                    {/* Price Preview */}
                    {price && (
                        <div className={`price-preview ${isValidPrice ? "valid" : "invalid"}`}>
                            {isValidPrice ? (
                                <>
                                    ...
                                    <div className="preview-content">
                                        ...
                                        <div className="preview-details">
                                            ...
                                            {(currentPrice - parseFloat(ticket.purchasePrice)).toFixed(2)} FEST
                                        </div>
                                    </div>
                                </>
                                ...
                                <>
                                    ...
                                    <div className="preview-content">
                                        <div className="preview-title error">Giá vượt quá giới hạn</div>
                                        <div className="preview-details error">Giá tối đa cho phép: {maxPrice.toFixed(2)} FEST (110%)</div>
                                    </div>
                                </>
                            ) : (
                                <>
                                    ...
                                    <div className="preview-content">
                                        ...
                                        <div className="preview-details error">Giá phải lớn hơn 0</div>
                                    </div>
                                </>
                            )}
                        </div>
