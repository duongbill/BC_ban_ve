...
async function main() {
  console.log("\n🚀 Starting deployment with FestivalNFTv2...\n");
  ...
  // 2. Deploy Factory v2
  console.log("2️⃣  Deploying FestiveTicketsFactoryv2...");
  const Factory = await hre.ethers.getContractFactory(
    "FestiveTicketsFactoryv2"
  );
  const factory = await Factory.deploy(festTokenAddress);
  await factory.waitForDeployment();
  const factoryAddress = await factory.getAddress();
  console.log("   ✅ Factory v2 deployed to:", factoryAddress, "\n");
  ...
  console.log("   ✅ Sample NFT (v2) deployed to:", sampleNFTAddress);
  console.log(
    "   ✅ Sample Marketplace (v2) deployed to:",
