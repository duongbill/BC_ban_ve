...
/**
 * @title FestivalNFTv2
 * @dev Enhanced NFT contract with event status, ticket transfer, and verification
 */
contract FestivalNFTv2 is ERC721URIStorage, AccessControl, ReentrancyGuard, Pausable {
